...
def _interval_result_adaptive(
    ...
    charge_hurdle = 0.0
    effective_import_price = 0.0
    effective_export_price = 0.0
    if not row["price_known"]:
        ...
        effective_import_price = float(prices["effective_import_price_ore_kwh"])
        effective_export_price = float(prices["effective_export_price_ore_kwh"])
        energy = (
            imp * DT_HOURS * effective_import_price
            - exp * DT_HOURS * effective_export_price
        )
    ...
    return {
        ...
        "effective_import_price_ore_kwh": effective_import_price,
        "effective_export_price_ore_kwh": effective_export_price,
