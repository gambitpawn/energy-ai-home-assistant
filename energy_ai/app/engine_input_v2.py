...
def enriched_common_objective(cfg: dict[str, Any], decision_start: str) -> dict[str, Any]:
    ...
    objective["tariff_state"] = tariff_state_for_decision(cfg, decision_start)
    return objective
...
def input_from_optimizer_plan_v2(plan: dict[str, Any], cfg: dict[str, Any]) -> EngineInput:
    ...
    return EngineInput(
        ...
        objective=enriched_common_objective(cfg, decision_start),
        source={
