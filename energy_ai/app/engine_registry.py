...
DESCRIPTORS: tuple[EngineDescriptor, ...] = (
    ...
    EngineDescriptor(
        ...
        family="neural",
        display_name="Neural",
        description="Learned battery-policy challenger with deterministic downstream safety.",
        baseline=False,
        available=True,
        trainable=True,
        learning_enabled=True,
    ...
    EngineDescriptor(
        ...
        family="hybrid",
        display_name="Hybrid",
        description="Neural-guided frozen-v3.5 constrained optimization with a bounded economic regret guard.",
        baseline=False,
        available=True,
        trainable=False,
        learning_enabled=True,
...
def registry_status() -> dict[str, Any]:
    ...
    return {
        ...
        "selection": {
            ...
            "note": "Engines compete on the same information vintage; physical authority remains downstream of the selector.",
        },
